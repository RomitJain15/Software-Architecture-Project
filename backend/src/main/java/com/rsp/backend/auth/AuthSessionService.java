...
import com.rsp.backend.cache.AuthSessionCacheService;
...
public class AuthSessionService {
    ...
    public AuthSession createSession(User user, Instant issuedAt, Instant expiresAt) {
        ...
        authSessionCacheService.cacheSession(saved, issuedAt);
        return saved;
    }

    public boolean isSessionActive(UUID sessionId, Instant now) {
        return authSessionCacheService.isSessionActive(sessionId, now);
    }
    ...
    public void revokeSession(UUID sessionId, Instant revokedAt, String reason) {
        ...
        authSessionCacheService.evictSession(sessionId);
    }
